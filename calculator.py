...
class Calculator(QWidget):
    def __init__(self):
        ...
        self.hbox_irst.addWidget(self.b_6)

        self.b_7 = QPushButton("7", self)
        self.hbox_irst.addWidget(self.b_7)
        self.b_8 = QPushButton("8", self)
        self.hbox_irst.addWidget(self.b_8)
        self.b_9 = QPushButton("9", self)
        self.hbox_irst.addWidget(self.b_9)

        self.b_0 = QPushButton("0", self)
        self.hbox_irst.addWidget(self.b_0)

        self.b_c = QPushButton("C", self)
        self.hbox_irst.addWidget(self.b_c)
        ...
        self.hbox_irst.addWidget(self.b_mult)

        self.b_div = QPushButton("/", self)
        self.hbox_irst.addWidget(self.b_div)

        self.b_result = QPushButton("=", self)
        self.hbox_result.addWidget(self.b_result)

        self.b_point = QPushButton(".", self)
        self.hbox_irst.addWidget(self.b_point)
        ...
        self.b_c.clicked.connect(lambda: self._clean())
